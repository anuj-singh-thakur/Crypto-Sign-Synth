...
architecture behav of pqcrystals_dilithium_8 is 
    ...
    signal i_3_fu_137_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_3_reg_218 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal t_1_fu_185_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    i_3_fu_137_p2 <= std_logic_vector(unsigned(i_0_i_reg_80) + unsigned(ap_const_lv9_1));
    ...
    icmp_ln303_fu_191_p2 <= "1" when (signed(t_1_fu_185_p2) < signed(bound_cast_reg_196)) else "0";
    ...
    t_1_fu_185_p2 <= std_logic_vector(unsigned(v_vec_coeffs_q0) - unsigned(and_ln301_fu_179_p2));
    t_fu_165_p3 <= 
        ap_const_lv32_FFFFFFFF when (tmp_2_fu_157_p3(0) = '1') else 
        ap_const_lv32_0;
    tmp_2_fu_157_p3 <= v_vec_coeffs_q0(31 downto 31);
