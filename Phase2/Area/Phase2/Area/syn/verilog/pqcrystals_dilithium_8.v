...
assign i_3_fu_137_p2 = (i_0_i_reg_80 + 9'd1);

assign i_fu_113_p2 = (i_0_reg_69 + 3'd1);

assign icmp_ln298_fu_131_p2 = ((i_0_i_reg_80 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln303_fu_191_p2 = (($signed(t_1_fu_185_p2) < $signed(bound_cast_reg_196)) ? 1'b1 : 1'b0);

assign icmp_ln325_fu_107_p2 = ((i_0_reg_69 == 3'd4) ? 1'b1 : 1'b0);

assign shl_ln301_fu_173_p2 = v_vec_coeffs_q0 << 32'd1;

assign t_1_fu_185_p2 = (v_vec_coeffs_q0 - and_ln301_fu_179_p2);

assign t_fu_165_p3 = ((tmp_2_fu_157_p3[0:0] === 1'b1) ? 32'd4294967295 : 32'd0);

assign tmp_2_fu_157_p3 = v_vec_coeffs_q0[32'd31];
