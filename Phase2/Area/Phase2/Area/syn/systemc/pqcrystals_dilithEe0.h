...
// ==============================================================
#ifndef __pqcrystals_dilithEe0__HH__
#define __pqcrystals_dilithEe0__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(pqcrystals_dilithEe0) {
    ...
    SC_CTOR(pqcrystals_dilithEe0):  simcore_mac_2_U ("simcore_mac_2_U") {
