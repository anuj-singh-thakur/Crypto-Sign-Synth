...
set C_modelArgList {
	{ x int 8 regular {array 5720 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ x_address1 sc_out sc_lv 13 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "x", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 13 }  { x_ce0 mem_ce 1 1 }  { x_q0 mem_dout 0 8 }  { x_address1 MemPortADDR2 1 13 }  { x_ce1 MemPortCE2 1 1 }  { x_q1 MemPortDOUT2 0 8 } } }
