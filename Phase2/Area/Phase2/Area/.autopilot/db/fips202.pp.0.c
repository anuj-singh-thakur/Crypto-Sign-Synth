# 1 "dilithium2/fips202.c"
# 1 "dilithium2/fips202.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 11 "dilithium2/fips202.c" 2
# 26 "dilithium2/fips202.c"
...
# 86 "dilithium2/fips202.c"
static void KeccakF1600_StatePermute(uint64_t state[25])
{_ssdm_SpecArrayDimSize(state, 25);
#pragma HLS ALLOCATION instances=KeccakF1600_StatePermute limit=2 function
# 87 "dilithium2/fips202.c"
...
#pragma HLS ALLOCATION instances=keccak_absorb limit=1 function
# 385 "dilithium2/fips202.c"
...
# 467 "dilithium2/fips202.c"
static void keccak_squeezeblocks(uint8_t *out,
                                 size_t nblocks,
                                 uint64_t s[25],
                                 unsigned int r)
{_ssdm_SpecArrayDimSize(s, 25);
#pragma HLS ALLOCATION instances=keccak_squeezeblocks limit=1 function
# 471 "dilithium2/fips202.c"
...
# 571 "dilithium2/fips202.c"
void shake128_init(keccak_state *state)
{
  keccak_init(state);
}
# 586 "dilithium2/fips202.c"
void shake128_absorb(keccak_state *state, const uint8_t *in, size_t inlen)
{
  state->pos = keccak_absorb(state->s, 168, state->pos, in, inlen);
}
# 598 "dilithium2/fips202.c"
void shake128_finalize(keccak_state *state)
{
  keccak_finalize(state->s, 168, state->pos, 0x1F);
  state->pos = 0;
}
# 617 "dilithium2/fips202.c"
void shake128_squeezeblocks(uint8_t *out, size_t nblocks, keccak_state *state)
{
#pragma HLS ALLOCATION instances=shake128_squeezeblocks limit=1 function
# 618 "dilithium2/fips202.c"
...
#pragma HLS ALLOCATION instances=shake256_absorb limit=1 function
# 662 "dilithium2/fips202.c"
...
# 673 "dilithium2/fips202.c"
void shake256_finalize(keccak_state state[1])
{_ssdm_SpecArrayDimSize(state, 1);
  keccak_finalize(state->s, 136, state->pos, 0x1F);
  state->pos = 0;
}
# 692 "dilithium2/fips202.c"
void shake256_squeezeblocks(uint8_t *out, size_t nblocks, keccak_state state[1])
{_ssdm_SpecArrayDimSize(state, 1);
#pragma HLS ALLOCATION instances=shake256_squeezeblocks limit=1 function
# 693 "dilithium2/fips202.c"
