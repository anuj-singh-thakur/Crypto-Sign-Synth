...
void poly_reduce(poly *a) {
  ...
  pqcrystals_dilithium2_ref_poly_reduce_label2:for(i = 0; i < N; ++i)
...
void poly_caddq(poly *a) {
  ...
  pqcrystals_dilithium2_ref_poly_caddq_label3:for(i = 0; i < N; ++i)
...
void poly_freeze(poly *a) {
  ...
  pqcrystals_dilithium2_ref_poly_freeze_label4:for(i = 0; i < N; ++i)
...
void poly_add(poly *c, const poly *a, const poly *b)  {
  ...
  pqcrystals_dilithium2_ref_poly_add_label5:for(i = 0; i < N; ++i)
...
void poly_sub(poly *c, const poly *a, const poly *b) {
  ...
  pqcrystals_dilithium2_ref_poly_sub_label6:for(i = 0; i < N; ++i)
    c->coeffs[i] = a->coeffs[i] - b->coeffs[i];
...
void poly_pointwise_montgomery(poly *c, const poly *a, const poly *b) {
  ...
  pqcrystals_dilithium2_ref_poly_pointwise_montgomery_label7:for(i = 0; i < N; ++i)
...
void poly_power2round(poly *a1, poly *a0, const poly *a) {
  ...
  pqcrystals_dilithium2_ref_poly_power2round_label8:for(i = 0; i < N; ++i)
                  ...
                  uint16_t nonce)
{
  ...
  pqcrystals_dilithium2_ref_poly_uniform_label1:while(ctr < N) {
    off = buflen % 3;
                      ...
                      uint16_t nonce)
{
  ...
  pqcrystals_dilithium2_ref_poly_uniform_eta_label9:while(ctr < N) {
...
void poly_challenge(poly *c, const uint8_t seed[SEEDBYTES]) {
  ...
  for(i = 0; i < N; ++i)
    c->coeffs[i] = 0;
  pqcrystals_dilithium2_ref_poly_challenge_label2:for(i = N-TAU; i < N; ++i) {
...
#if ETA == 2
  pqcrystals_dilithium2_ref_polyeta_pack_label10:for(i = 0; i < N/8; ++i) {
...
void polyt1_pack(uint8_t *r, const poly *a) {
  ...
  pqcrystals_dilithium2_ref_polyt1_pack_label11:for(i = 0; i < N/4; ++i) {
...
void polyt0_pack(uint8_t *r, const poly *a) {
  ...
  pqcrystals_dilithium2_ref_polyt0_pack_label12:for(i = 0; i < N/8; ++i) {
