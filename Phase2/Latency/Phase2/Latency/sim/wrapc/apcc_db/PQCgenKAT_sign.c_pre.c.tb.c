...
signed int AESL_WRAP_pqcrystals_dilithium2_ref( char *, signed long long *,  char *, signed long long ,  char *);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__62);
if (AESL_DEBUG_TRACE)
printf("\n  %%84 = call i32 @AESL_WRAP_pqcrystals_dilithium2_ref(i8* %%48, i64* %%smlen, i8* %%45, i64 %%83, i8* %%47) nounwind, !dbg !26 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_275_count);
  llvm_cbe_tmp__63 = (unsigned int )AESL_WRAP_pqcrystals_dilithium2_ref(( char *)llvm_cbe_tmp__42, (signed long long *)(&llvm_cbe_smlen), ( char *)llvm_cbe_tmp__39, llvm_cbe_tmp__62, ( char *)llvm_cbe_tmp__41);
if (AESL_DEBUG_TRACE) {
