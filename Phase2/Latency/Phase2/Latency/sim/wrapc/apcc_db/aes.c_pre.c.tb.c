...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = tail call fastcc zeroext i8 @aesl_internal_xtime(i8 zeroext %%6), !dbg !18 for 0x%I64xth hint within @aesl_internal_InvMixColumns  --> \n", ++aesl_llvm_cbe_1574_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = tail call fastcc zeroext i8 @aesl_internal_xtime(i8 zeroext %%14), !dbg !15 for 0x%I64xth hint within @aesl_internal_InvMixColumns  --> \n", ++aesl_llvm_cbe_1575_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = tail call fastcc zeroext i8 @aesl_internal_xtime(i8 zeroext %%15), !dbg !15 for 0x%I64xth hint within @aesl_internal_InvMixColumns  --> \n", ++aesl_llvm_cbe_1576_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = tail call fastcc zeroext i8 @aesl_internal_xtime(i8 zeroext %%8), !dbg !15 for 0x%I64xth hint within @aesl_internal_InvMixColumns  --> \n", ++aesl_llvm_cbe_1577_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = tail call fastcc zeroext i8 @aesl_internal_xtime(i8 zeroext %%17), !dbg !15 for 0x%I64xth hint within @aesl_internal_InvMixColumns  --> \n", ++aesl_llvm_cbe_1578_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = tail call fastcc zeroext i8 @aesl_internal_xtime(i8 zeroext %%18), !dbg !15 for 0x%I64xth hint within @aesl_internal_InvMixColumns  --> \n", ++aesl_llvm_cbe_1579_count);
