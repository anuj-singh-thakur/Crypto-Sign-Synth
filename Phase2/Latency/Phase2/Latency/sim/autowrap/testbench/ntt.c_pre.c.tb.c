...
// ==============================================================
# 1 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/ntt.c"
# 1 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/ntt.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/ntt.c" 2
...
# 2 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/ntt.c" 2
...
# 3 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/ntt.c" 2
...
# 4 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/ntt.c" 2
...
# 5 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/ntt.c" 2
...
# 49 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/ntt.c"
void pqcrystals_dilithium2_ref_ntt(int32_t a[256]) {
  unsigned int len, start, j, k;
  int32_t zeta, t;

  k = 0;
  pqcrystals_dilithium2_ref_ntt_label7:for(len = 128; len > 0; len >>= 1) {
    pqcrystals_dilithium2_ref_ntt_label8:for(start = 0; start < 256; start = j + len) {
      zeta = zetas[++k];
      pqcrystals_dilithium2_ref_ntt_label9:for(j = start; j < start + len; ++j) {
...
# 77 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/ntt.c"
void pqcrystals_dilithium2_ref_invntt_tomont(int32_t a[256]) {
  ...
  k = 256;
  pqcrystals_dilithium2_ref_invntt_tomont_label4:for(len = 1; len < 256; len <<= 1) {
    pqcrystals_dilithium2_ref_invntt_tomont_label5:for(start = 0; start < 256; start = j + len) {
      zeta = -zetas[--k];
      pqcrystals_dilithium2_ref_invntt_tomont_label6:for(j = start; j < start + len; ++j) {
        t = a[j];
        a[j] = t + a[j + len];
        a[j + len] = t - a[j + len];
  ...
  pqcrystals_dilithium2_ref_invntt_tomont_label16:for(j = 0; j < 256; ++j) {
