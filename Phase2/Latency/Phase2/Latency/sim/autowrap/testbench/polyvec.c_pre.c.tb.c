...
// ==============================================================
# 1 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
# 1 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c" 2
...
# 2 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c" 2
...
# 3 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c" 2
...
# 4 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c" 2
# 17 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyvec_matrix_expand(polyvecl mat[4], const uint8_t rho[32]) {
  unsigned int i, j;
...
void pqcrystals_dilithium2_ref_polyvecl_uniform_eta(polyvecl *v, const uint8_t seed[32], uint16_t nonce) {
  ...
  pqcrystals_dilithium2_ref_polyvecl_uniform_eta_label15:for(i = 0; i < 4; ++i)
...
void pqcrystals_dilithium2_ref_polyvecl_reduce(polyvecl *v) {
  ...
  pqcrystals_dilithium2_ref_polyvecl_reduce_label14:for(i = 0; i < 4; ++i)
    pqcrystals_dilithium2_ref_poly_reduce(&v->vec[i]);
}
# 65 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyvecl_freeze(polyvecl *v) {
  unsigned int i;
...
# 82 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyvecl_add(polyvecl *w, const polyvecl *u, const polyvecl *v) {
  unsigned int i;
...
# 97 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyvecl_ntt(polyvecl *v) {
  unsigned int i;
...
# 129 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyvecl_pointwise_acc_montgomery(poly *w,
                                       const polyvecl *u,
                                       const polyvecl *v)
{
  ...
  pqcrystals_dilithium2_ref_polyvecl_pointwise_acc_montgomery_label1:for(i = 1; i < 4; ++i) {
    pqcrystals_dilithium2_ref_poly_pointwise_montgomery(&t, &u->vec[i], &v->vec[i]);
    pqcrystals_dilithium2_ref_poly_add(w, w, &t);
  }
}
# 155 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
...
# 184 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyveck_reduce(polyveck *v) {
  unsigned int i;
...
# 199 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyveck_caddq(polyveck *v) {
  unsigned int i;
...
# 214 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyveck_freeze(polyveck *v) {
  unsigned int i;
...
# 231 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyveck_add(polyveck *w, const polyveck *u, const polyveck *v) {
  unsigned int i;
...
# 249 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyveck_sub(polyveck *w, const polyveck *u, const polyveck *v) {
  unsigned int i;
...
# 264 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyveck_shiftl(polyveck *v) {
  unsigned int i;
...
# 279 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyveck_ntt(polyveck *v) {
  unsigned int i;
...
# 295 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyveck_invntt_tomont(polyveck *v) {
  unsigned int i;
...
# 322 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
...
# 346 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyveck_power2round(polyveck *v1, polyveck *v0, const polyveck *v) {
  unsigned int i;
...
# 368 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
void pqcrystals_dilithium2_ref_polyveck_decompose(polyveck *v1, polyveck *v0, const polyveck *v) {
  unsigned int i;
...
# 386 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
unsigned int pqcrystals_dilithium2_ref_polyveck_make_hint(polyveck *h,
                                const polyveck *v0,
                                const polyveck *v1)
{
...
# 408 "C:/Users/Hp/Desktop/IITG/MTech_Course_2_Sem/C_BASED_VLSI/AssignmentPhase_2_Latency/dilithium2/polyvec.c"
