...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.pqcrystals_dilithium2_ref.autotvin_sm.dat"
         "c.pqcrystals_dilithium2_ref.autotvin_m.dat"
         "c.pqcrystals_dilithium2_ref.autotvin_mlen.dat"
         "c.pqcrystals_dilithium2_ref.autotvin_sk.dat"
         "c.pqcrystals_dilithium2_ref.autotvout_sm.dat"
         "c.pqcrystals_dilithium2_ref.autotvout_smlen.dat"
         "c.pqcrystals_dilithium2_ref.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.pqcrystals_dilithium2_ref.autotvout_sm.dat"
         "rtl.pqcrystals_dilithium2_ref.autotvout_smlen.dat"
         "rtl.pqcrystals_dilithium2_ref.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
