...
module pqcrystals_dilithium_23 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7:0] trunc_ln_reg_719;
reg   [7:0] trunc_ln1_reg_724;
wire   [7:0] shl_ln_fu_338_p3;
reg   [7:0] shl_ln_reg_729;
wire    ap_CS_fsm_state4;
reg   [7:0] trunc_ln2_reg_740;
wire    ap_CS_fsm_state5;
reg   [7:0] trunc_ln3_reg_745;
wire    ap_CS_fsm_state6;
reg   [7:0] trunc_ln4_reg_755;
wire    ap_CS_fsm_state7;
reg   [7:0] trunc_ln5_reg_760;
wire    ap_CS_fsm_state8;
reg   [7:0] trunc_ln6_reg_770;
wire    ap_CS_fsm_state9;
reg   [7:0] trunc_ln7_reg_775;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        trunc_ln1_reg_724 <= {{grp_fu_239_p2[23:16]}};
        trunc_ln_reg_719 <= {{grp_fu_239_p2[15:8]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        trunc_ln2_reg_740 <= {{grp_fu_239_p2[13:6]}};
        trunc_ln3_reg_745 <= {{grp_fu_239_p2[21:14]}};
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        trunc_ln4_reg_755 <= {{grp_fu_239_p2[11:4]}};
        trunc_ln5_reg_760 <= {{grp_fu_239_p2[19:12]}};
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        trunc_ln6_reg_770 <= {{grp_fu_239_p2[9:2]}};
        trunc_ln7_reg_775 <= {{grp_fu_239_p2[17:10]}};
    end
end
...
assign or_ln813_fu_413_p2 = (trunc_ln1_reg_724 | shl_ln7_fu_405_p3);

assign or_ln816_fu_506_p2 = (trunc_ln3_reg_745 | shl_ln8_fu_498_p3);

assign or_ln819_fu_599_p2 = (trunc_ln5_reg_760 | shl_ln9_fu_591_p3);
...
assign tmp_s_fu_269_p4 = {{{a_coeffs_offset}, {trunc_ln805_fu_265_p1}}, {2'd0}};
...
assign zext_ln805_fu_278_p1 = tmp_s_fu_269_p4;
...
endmodule //pqcrystals_dilithium_23
