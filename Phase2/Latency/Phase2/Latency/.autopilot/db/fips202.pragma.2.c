...
_ssdm_op_SpecResourceLimit(1, "", "", "keccak_absorb", "");
...
static void keccak_squeezeblocks(uint8_t *out,
                                 ...
                                 unsigned int r)
{_ssdm_SpecArrayDimSize(s, 25);
_ssdm_op_SpecResourceLimit(1, "", "", "keccak_squeezeblocks", "");
...
void shake128_squeezeblocks(uint8_t *out, size_t nblocks, keccak_state *state)
{
_ssdm_op_SpecResourceLimit(1, "", "", "shake128_squeezeblocks", "");
...
_ssdm_op_SpecResourceLimit(1, "", "", "shake256_absorb", "");
...
void shake256_squeezeblocks(uint8_t *out, size_t nblocks, keccak_state state[1])
{_ssdm_SpecArrayDimSize(state, 1);
_ssdm_op_SpecResourceLimit(1, "", "", "shake256_squeezeblocks", "");
