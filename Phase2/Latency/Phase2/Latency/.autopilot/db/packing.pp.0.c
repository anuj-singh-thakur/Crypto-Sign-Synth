# 1 "dilithium2/packing.c"
# 1 "dilithium2/packing.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 3 "dilithium2/packing.c" 2
# 15 "dilithium2/packing.c"
void pqcrystals_dilithium2_ref_pack_pk(uint8_t pk[(32 + 4*320)],
             const uint8_t rho[32],
             const polyveck *t1)
