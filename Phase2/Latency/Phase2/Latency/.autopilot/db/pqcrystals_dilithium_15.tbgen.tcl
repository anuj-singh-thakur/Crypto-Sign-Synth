set moduleName pqcrystals_dilithium_15
set isTopModule 0
...
set C_modelName {pqcrystals_dilithium.15}
set C_modelType { void 0 }
set C_modelArgList {
	{ c_coeffs int 32 regular {array 256 { 2 3 } 1 1 }  }
	{ seed int 8 regular {array 5720 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ seed_address1 sc_out sc_lv 13 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "seed_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "seed", "role": "address1" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_KeccakF1600_StatePer_1_fu_589", "Port" : "KeccakF_RoundConstan"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.buf_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.state_s_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_KeccakF1600_StatePer_1_fu_589", "Parent" : "0", "Child" : ["4"],
		...
		"Port" : [
			...
			{"Name" : "KeccakF_RoundConstan", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_KeccakF1600_StatePer_1_fu_589.KeccakF_RoundConstan_U", "Parent" : "3"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "684", "Max" : "5598"}
	, {"Name" : "Interval", "Min" : "684", "Max" : "5598"}
]}
...
set Spec2ImplPortList { 
	...
	seed { ap_memory {  { seed_address0 mem_address 1 13 }  { seed_ce0 mem_ce 1 1 }  { seed_q0 mem_dout 0 8 }  { seed_address1 MemPortADDR2 1 13 }  { seed_ce1 MemPortCE2 1 1 }  { seed_q1 MemPortDOUT2 0 8 } } }
}
