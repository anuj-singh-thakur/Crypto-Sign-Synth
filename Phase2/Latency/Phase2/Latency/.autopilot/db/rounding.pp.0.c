# 1 "dilithium2/rounding.c"
# 1 "dilithium2/rounding.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 4 "dilithium2/rounding.c" 2
# 17 "dilithium2/rounding.c"
int32_t pqcrystals_dilithium2_ref_power2round(int32_t *a0, int32_t a) {
#pragma HLS INLINE
# 17 "dilithium2/rounding.c"
