...
// ==============================================================
#ifndef __pqcrystals_dilithDeQ__HH__
#define __pqcrystals_dilithDeQ__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(pqcrystals_dilithDeQ) {
    ...
    SC_CTOR(pqcrystals_dilithDeQ):  simcore_mac_1_U ("simcore_mac_1_U") {
