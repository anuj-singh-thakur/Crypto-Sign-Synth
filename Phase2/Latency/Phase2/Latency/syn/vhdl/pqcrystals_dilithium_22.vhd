...
architecture behav of pqcrystals_dilithium_22 is 
    ...
    signal i_9_fu_542_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal i_10_fu_564_p2 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state9) and (icmp_ln423_fu_536_p2 = ap_const_lv1_1))) then 
                ...
                i_5_i_i_reg_359 <= i_10_fu_564_p2;
            end if; 
        end if;
    end process;
    ...
    i_10_fu_564_p2 <= std_logic_vector(unsigned(i_5_i_i_reg_359) + unsigned(ap_const_lv2_1));
    i_9_fu_542_p2 <= std_logic_vector(unsigned(i_4_i_i_reg_348) + unsigned(ap_const_lv4_1));
