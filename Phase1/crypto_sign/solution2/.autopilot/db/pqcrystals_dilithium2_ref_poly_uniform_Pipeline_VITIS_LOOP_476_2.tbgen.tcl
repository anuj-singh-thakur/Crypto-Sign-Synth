set moduleName pqcrystals_dilithium2_ref_poly_uniform_Pipeline_VITIS_LOOP_476_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_poly_uniform_Pipeline_VITIS_LOOP_476_2}
