set moduleName pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_371_1_VITIS_LOOP_225_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_signature.1_Pipeline_VITIS_LOOP_371_1_VITIS_LOOP_225_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ w1_vec_coeffs int 32 regular {array 1024 { 0 1 } 1 1 }  }
	{ w0_vec_coeffs int 32 regular {array 1024 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "w1_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "w0_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ w1_vec_coeffs_address0 sc_out sc_lv 10 signal 0 } 
	{ w1_vec_coeffs_ce0 sc_out sc_logic 1 signal 0 } 
	{ w1_vec_coeffs_we0 sc_out sc_logic 1 signal 0 } 
	{ w1_vec_coeffs_d0 sc_out sc_lv 32 signal 0 } 
	{ w1_vec_coeffs_address1 sc_out sc_lv 10 signal 0 } 
	{ w1_vec_coeffs_ce1 sc_out sc_logic 1 signal 0 } 
	{ w1_vec_coeffs_q1 sc_in sc_lv 32 signal 0 } 
	{ w0_vec_coeffs_address0 sc_out sc_lv 10 signal 1 } 
	{ w0_vec_coeffs_ce0 sc_out sc_logic 1 signal 1 } 
	{ w0_vec_coeffs_we0 sc_out sc_logic 1 signal 1 } 
	{ w0_vec_coeffs_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_25s_14ns_24ns_32_4_1_U234", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8s_19s_32s_32_4_1_U235", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	w0_vec_coeffs { ap_memory {  { w0_vec_coeffs_address0 mem_address 1 10 }  { w0_vec_coeffs_ce0 mem_ce 1 1 }  { w0_vec_coeffs_we0 mem_we 1 1 }  { w0_vec_coeffs_d0 mem_din 1 32 } } }
}
