set moduleName pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_126_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_signature.1_Pipeline_VITIS_LOOP_126_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ sk int 8 regular {array 2544 { 1 3 } 1 1 }  }
	{ seedbuf int 8 regular {array 208 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	sk { ap_memory {  { sk_address0 mem_address 1 12 }  { sk_ce0 mem_ce 1 1 }  { sk_q0 in_data 0 8 } } }
	seedbuf { ap_memory {  { seedbuf_address0 mem_address 1 8 }  { seedbuf_ce0 mem_ce 1 1 }  { seedbuf_we0 mem_we 1 1 }  { seedbuf_d0 mem_din 1 8 } } }
}
