set moduleName pqcrystals_dilithium2_ref_poly_uniform_Pipeline_VITIS_LOOP_379_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_poly_uniform_Pipeline_VITIS_LOOP_379_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ trunc_ln367_1 int 2 regular  }
	{ sext_ln379 int 9 regular  }
	{ buf_r int 8 regular {array 842 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "trunc_ln367_1", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln379", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ trunc_ln367_1 sc_in sc_lv 2 signal 0 } 
	{ sext_ln379 sc_in sc_lv 9 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln367_1", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "trunc_ln367_1", "role": "default" }} , 
 	{ "name": "sext_ln379", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "sext_ln379", "role": "default" }} , 
...
set Spec2ImplPortList { 
	trunc_ln367_1 { ap_none {  { trunc_ln367_1 in_data 0 2 } } }
	sext_ln379 { ap_none {  { sext_ln379 in_data 0 9 } } }
	buf_r { ap_memory {  { buf_r_address0 mem_address 1 10 }  { buf_r_ce0 mem_ce 1 1 }  { buf_r_we0 mem_we 1 1 }  { buf_r_d0 mem_din 1 8 }  { buf_r_address1 MemPortADDR2 1 10 }  { buf_r_ce1 MemPortCE2 1 1 }  { buf_r_q1 in_data 0 8 } } }
}
