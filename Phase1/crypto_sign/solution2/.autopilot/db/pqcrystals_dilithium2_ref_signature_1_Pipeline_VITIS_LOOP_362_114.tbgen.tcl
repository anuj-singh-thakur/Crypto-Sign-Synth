set moduleName pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_362_114
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_signature.1_Pipeline_VITIS_LOOP_362_114}
set C_modelType { void 0 }
set C_modelArgList {
	{ state_s int 64 regular {array 25 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "state_s", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	state_s { ap_memory {  { state_s_address0 mem_address 1 5 }  { state_s_ce0 mem_ce 1 1 }  { state_s_we0 mem_we 1 1 }  { state_s_d0 mem_din 1 64 } } }
}
