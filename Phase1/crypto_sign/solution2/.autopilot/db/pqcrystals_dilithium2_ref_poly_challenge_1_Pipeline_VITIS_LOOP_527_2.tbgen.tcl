set moduleName pqcrystals_dilithium2_ref_poly_challenge_1_Pipeline_VITIS_LOOP_527_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_poly_challenge.1_Pipeline_VITIS_LOOP_527_2}
