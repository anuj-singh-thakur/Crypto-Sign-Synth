set moduleName pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_392_1_VITIS_LOOP_248_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_signature.1_Pipeline_VITIS_LOOP_392_1_VITIS_LOOP_248_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ w1_vec_coeffs int 32 regular {array 1024 { 1 3 } 1 1 }  }
	{ w0_vec_coeffs int 32 regular {array 1024 { 1 3 } 1 1 }  }
	{ h_vec_coeffs int 32 regular {array 1024 { 0 3 } 0 1 }  }
	{ s_4_out int 11 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "w1_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "s_4_out", "interface" : "wire", "bitwidth" : 11, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ w1_vec_coeffs_q0 sc_in sc_lv 32 signal 0 } 
	{ w0_vec_coeffs_address0 sc_out sc_lv 10 signal 1 } 
	{ w0_vec_coeffs_ce0 sc_out sc_logic 1 signal 1 } 
	{ w0_vec_coeffs_q0 sc_in sc_lv 32 signal 1 } 
	{ h_vec_coeffs_address0 sc_out sc_lv 10 signal 2 } 
	{ h_vec_coeffs_ce0 sc_out sc_logic 1 signal 2 } 
	{ h_vec_coeffs_we0 sc_out sc_logic 1 signal 2 } 
	{ h_vec_coeffs_d0 sc_out sc_lv 32 signal 2 } 
	{ s_4_out sc_out sc_lv 11 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "s_4_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	w1_vec_coeffs { ap_memory {  { w1_vec_coeffs_address0 mem_address 1 10 }  { w1_vec_coeffs_ce0 mem_ce 1 1 }  { w1_vec_coeffs_q0 in_data 0 32 } } }
	...
	s_4_out { ap_vld {  { s_4_out out_data 1 11 }  { s_4_out_ap_vld out_vld 1 1 } } }
}
