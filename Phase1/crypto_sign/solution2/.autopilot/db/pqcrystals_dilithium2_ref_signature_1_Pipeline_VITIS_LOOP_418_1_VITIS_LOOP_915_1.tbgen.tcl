set moduleName pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_418_1_VITIS_LOOP_915_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_signature.1_Pipeline_VITIS_LOOP_418_1_VITIS_LOOP_915_1}
...
set portList { 
	...
	{ sm_we0 sc_out sc_logic 1 signal 1 } 
	{ sm_d0 sc_out sc_lv 8 signal 1 } 
	{ sm_address1 sc_out sc_lv 13 signal 1 } 
	{ sm_ce1 sc_out sc_logic 1 signal 1 } 
	{ sm_we1 sc_out sc_logic 1 signal 1 } 
	{ sm_d1 sc_out sc_lv 8 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	w1_vec_coeffs { ap_memory {  { w1_vec_coeffs_address0 mem_address 1 10 }  { w1_vec_coeffs_ce0 mem_ce 1 1 }  { w1_vec_coeffs_q0 in_data 0 32 }  { w1_vec_coeffs_address1 MemPortADDR2 1 10 }  { w1_vec_coeffs_ce1 MemPortCE2 1 1 }  { w1_vec_coeffs_q1 in_data 0 32 } } }
