...
// ==============================================================
# 1 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
# 1 "/home/shikha/Final_Assignment/dilithium2/fips202.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/shikha/Final_Assignment/dilithium2/fips202.c" 2
...
typedef int wchar_t;
# 9 "/home/shikha/Final_Assignment/dilithium2/fips202.c" 2
...
# 10 "/home/shikha/Final_Assignment/dilithium2/fips202.c" 2
...
# 11 "/home/shikha/Final_Assignment/dilithium2/fips202.c" 2
# 26 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
...
# 44 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
...
# 86 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
...
# 359 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
...
# 380 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
...
# 444 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
...
# 467 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
...
# 498 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
...
# 571 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake128_init(keccak_state *state)
{
  keccak_init(state);
}
# 586 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake128_absorb(keccak_state *state, const uint8_t *in, size_t inlen)
{
  state->pos = keccak_absorb(state->s, 168, state->pos, in, inlen);
}
# 598 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake128_finalize(keccak_state *state)
{
  keccak_finalize(state->s, 168, state->pos, 0x1F);
  state->pos = 0;
}
# 617 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake128_squeezeblocks(uint8_t *out, size_t nblocks, keccak_state *state)
{
  keccak_squeezeblocks(out, nblocks, state->s, 168);
}
# 633 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake128_squeeze(uint8_t *out, size_t outlen, keccak_state *state)
{
  state->pos = keccak_squeeze(out, outlen, state->s, 168, state->pos);
}
# 646 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake256_init(keccak_state state[1])
{
  keccak_init(state);
}
# 661 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
...
# 673 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake256_finalize(keccak_state state[1])
{
  keccak_finalize(state->s, 136, state->pos, 0x1F);
  state->pos = 0;
}
# 692 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake256_squeezeblocks(uint8_t *out, size_t nblocks, keccak_state state[1])
{
  keccak_squeezeblocks(out, nblocks, state->s, 136);
}
# 708 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake256_squeeze(uint8_t *out, size_t outlen, keccak_state state[1])
{
  state->pos = keccak_squeeze(out, outlen, state->s, 136, state->pos);
}
# 723 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake128(uint8_t *out, size_t outlen, const uint8_t *in, size_t inlen)
{
  keccak_state state;
...
# 743 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void shake256(uint8_t out[3*32], size_t outlen, const uint8_t in[32], size_t inlen)
{
...
# 762 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void sha3_256(uint8_t h[32], const uint8_t *in, size_t inlen)
{
  uint64_t s[25] = {0};
  unsigned int pos;
...
# 781 "/home/shikha/Final_Assignment/dilithium2/fips202.c"
void sha3_512(uint8_t h[64], const uint8_t *in, size_t inlen)
{
  uint64_t s[25] = {0};
  unsigned int pos;
