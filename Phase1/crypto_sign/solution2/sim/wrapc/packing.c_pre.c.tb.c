...
// ==============================================================
# 1 "/home/shikha/Final_Assignment/dilithium2/packing.c"
# 1 "/home/shikha/Final_Assignment/dilithium2/packing.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/shikha/Final_Assignment/dilithium2/packing.c" 2
...
# 2 "/home/shikha/Final_Assignment/dilithium2/packing.c" 2
...
# 5 "/home/shikha/Final_Assignment/dilithium2/packing.h" 2
...
# 7 "/home/shikha/Final_Assignment/dilithium2/packing.h" 2
...
# 3 "/home/shikha/Final_Assignment/dilithium2/packing.c" 2
# 15 "/home/shikha/Final_Assignment/dilithium2/packing.c"
void pqcrystals_dilithium2_ref_pack_pk(uint8_t pk[(32 + 4*320)],
             const uint8_t rho[32],
             const polyveck *t1)
{
...
# 38 "/home/shikha/Final_Assignment/dilithium2/packing.c"
...
# 65 "/home/shikha/Final_Assignment/dilithium2/packing.c"
void pqcrystals_dilithium2_ref_pack_sk(uint8_t sk[(2*32 + 48 + 4*96 + 4*96 + 4*416)],
             const uint8_t rho[32],
             const uint8_t tr[48],
             const uint8_t key[32],
...
# 112 "/home/shikha/Final_Assignment/dilithium2/packing.c"
void pqcrystals_dilithium2_ref_upack_sk(uint8_t rho[32],
               uint8_t tr[48],
               uint8_t key[32],
               polyveck *t0,
...
# 156 "/home/shikha/Final_Assignment/dilithium2/packing.c"
void pqcrystals_dilithium2_ref_pack_sig(uint8_t sig[(32 + 4*576 + (80 + 4))],
              const uint8_t c[32],
              const polyvecl *z,
              const polyveck *h)
...
# 198 "/home/shikha/Final_Assignment/dilithium2/packing.c"
