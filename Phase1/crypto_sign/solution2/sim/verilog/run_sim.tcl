...
if {[file isfile pqcrystals_dilithium2_ref.autotvin.dat]} {
	file delete -force pqcrystals_dilithium2_ref.autotvin.dat
}

if {[file isfile pqcrystals_dilithium2_ref.autotvout.dat]} {
	file delete -force pqcrystals_dilithium2_ref.autotvout.dat
}
