set moduleName pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_540_59
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_signature.1_Pipeline_VITIS_LOOP_540_59}
set C_modelType { void 0 }
set C_modelArgList {
	{ state_s_0 int 64 regular {array 25 { 1 3 } 1 1 }  }
	{ seedbuf int 8 regular {array 208 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "state_s_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ state_s_0_address0 sc_out sc_lv 5 signal 0 } 
	{ state_s_0_ce0 sc_out sc_logic 1 signal 0 } 
	{ state_s_0_q0 sc_in sc_lv 64 signal 0 } 
	{ seedbuf_address0 sc_out sc_lv 8 signal 1 } 
	{ seedbuf_ce0 sc_out sc_logic 1 signal 1 } 
	{ seedbuf_we0 sc_out sc_logic 1 signal 1 } 
	{ seedbuf_d0 sc_out sc_lv 8 signal 1 } 
	{ seedbuf_address1 sc_out sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "state_s_0_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "state_s_0", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	state_s_0 { ap_memory {  { state_s_0_address0 mem_address 1 5 }  { state_s_0_ce0 mem_ce 1 1 }  { state_s_0_q0 in_data 0 64 } } }
	seedbuf { ap_memory {  { seedbuf_address0 mem_address 1 8 }  { seedbuf_ce0 mem_ce 1 1 }  { seedbuf_we0 mem_we 1 1 }  { seedbuf_d0 mem_din 1 8 }  { seedbuf_address1 MemPortADDR2 1 8 }  { seedbuf_ce1 MemPortCE2 1 1 }  { seedbuf_we1 MemPortWE2 1 1 }  { seedbuf_d1 MemPortDIN2 1 8 } } }
}
