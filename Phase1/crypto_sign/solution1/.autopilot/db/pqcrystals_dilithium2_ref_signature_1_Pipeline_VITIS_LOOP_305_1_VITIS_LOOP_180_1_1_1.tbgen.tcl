set moduleName pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_305_1_VITIS_LOOP_180_1_1_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_signature.1_Pipeline_VITIS_LOOP_305_1_VITIS_LOOP_180_1.1.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ s2_vec_coeffs int 32 regular {array 1024 { 1 3 } 1 1 }  }
	{ h_vec_coeffs int 32 regular {array 1024 { 0 3 } 0 1 }  }
	{ cp_coeffs int 32 regular {array 256 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "s2_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "h_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "cp_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ s2_vec_coeffs_address0 sc_out sc_lv 10 signal 0 } 
	{ s2_vec_coeffs_ce0 sc_out sc_logic 1 signal 0 } 
	{ s2_vec_coeffs_q0 sc_in sc_lv 32 signal 0 } 
	...
	{ h_vec_coeffs_d0 sc_out sc_lv 32 signal 1 } 
	{ cp_coeffs_address0 sc_out sc_lv 8 signal 2 } 
	{ cp_coeffs_ce0 sc_out sc_logic 1 signal 2 } 
	{ cp_coeffs_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_64_1_1_U289", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_27ns_32_1_1_U290", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_24s_55_1_1_U291", "Parent" : "0"},
...
set Spec2ImplPortList { 
	s2_vec_coeffs { ap_memory {  { s2_vec_coeffs_address0 mem_address 1 10 }  { s2_vec_coeffs_ce0 mem_ce 1 1 }  { s2_vec_coeffs_q0 in_data 0 32 } } }
	h_vec_coeffs { ap_memory {  { h_vec_coeffs_address0 mem_address 1 10 }  { h_vec_coeffs_ce0 mem_ce 1 1 }  { h_vec_coeffs_we0 mem_we 1 1 }  { h_vec_coeffs_d0 mem_din 1 32 } } }
	cp_coeffs { ap_memory {  { cp_coeffs_address0 mem_address 1 8 }  { cp_coeffs_ce0 mem_ce 1 1 }  { cp_coeffs_q0 in_data 0 32 } } }
}
