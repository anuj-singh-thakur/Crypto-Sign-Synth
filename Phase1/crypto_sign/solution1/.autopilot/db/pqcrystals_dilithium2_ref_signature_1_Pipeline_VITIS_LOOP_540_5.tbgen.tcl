set moduleName pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_540_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_signature.1_Pipeline_VITIS_LOOP_540_5}
