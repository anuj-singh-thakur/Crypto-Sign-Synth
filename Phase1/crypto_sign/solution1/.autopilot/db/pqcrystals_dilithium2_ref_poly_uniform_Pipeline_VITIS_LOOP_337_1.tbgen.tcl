set moduleName pqcrystals_dilithium2_ref_poly_uniform_Pipeline_VITIS_LOOP_337_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_poly_uniform_Pipeline_VITIS_LOOP_337_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ buf_r int 8 regular {array 842 { 1 1 } 1 1 }  }
	{ zext_ln344_3 int 12 regular  }
	{ a int 23 regular {array 4096 { 0 3 } 0 1 }  }
	{ ctr_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "buf_r", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ctr_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln344_3 sc_in sc_lv 12 signal 1 } 
	{ a_address0 sc_out sc_lv 12 signal 2 } 
	{ a_ce0 sc_out sc_logic 1 signal 2 } 
	{ a_we0 sc_out sc_logic 1 signal 2 } 
	{ a_d0 sc_out sc_lv 23 signal 2 } 
	{ ctr_out sc_out sc_lv 32 signal 3 } 
	{ ctr_out_ap_vld sc_out sc_logic 1 outvld 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ctr_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ctr_out", "role": "default" }} , 
 	{ "name": "ctr_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "ctr_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	ctr_out { ap_vld {  { ctr_out out_data 1 32 }  { ctr_out_ap_vld out_vld 1 1 } } }
}
