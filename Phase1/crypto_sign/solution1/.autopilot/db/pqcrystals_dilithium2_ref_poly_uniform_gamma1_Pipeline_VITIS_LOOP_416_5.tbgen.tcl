set moduleName pqcrystals_dilithium2_ref_poly_uniform_gamma1_Pipeline_VITIS_LOOP_416_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_poly_uniform_gamma1_Pipeline_VITIS_LOOP_416_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ seed int 8 regular {array 208 { 1 1 } 1 1 }  }
	{ state_s int 64 regular {array 25 { 0 1 } 1 1 }  }
}
...
set portList { 
	...
	{ seed_address0 sc_out sc_lv 8 signal 0 } 
	{ seed_ce0 sc_out sc_logic 1 signal 0 } 
	{ seed_q0 sc_in sc_lv 8 signal 0 } 
	{ seed_address1 sc_out sc_lv 8 signal 0 } 
	{ seed_ce1 sc_out sc_logic 1 signal 0 } 
	{ seed_q1 sc_in sc_lv 8 signal 0 } 
...
set Spec2ImplPortList { 
	seed { ap_memory {  { seed_address0 mem_address 1 8 }  { seed_ce0 mem_ce 1 1 }  { seed_q0 in_data 0 8 }  { seed_address1 MemPortADDR2 1 8 }  { seed_ce1 MemPortCE2 1 1 }  { seed_q1 in_data 0 8 } } }
	state_s { ap_memory {  { state_s_address0 mem_address 1 5 }  { state_s_ce0 mem_ce 1 1 }  { state_s_we0 mem_we 1 1 }  { state_s_d0 mem_din 1 64 }  { state_s_address1 MemPortADDR2 1 5 }  { state_s_ce1 MemPortCE2 1 1 }  { state_s_q1 MemPortDOUT2 0 64 } } }
}
