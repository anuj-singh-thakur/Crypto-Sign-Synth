set moduleName pqcrystals_dilithium2_ref_poly_uniform_Pipeline_VITIS_LOOP_476_221
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_poly_uniform_Pipeline_VITIS_LOOP_476_221}
set C_modelType { void 0 }
set C_modelArgList {
	{ state_s int 64 regular {array 25 { 1 3 } 1 1 }  }
	{ trunc_ln367_1 int 2 regular  }
	{ buf_r int 8 regular {array 842 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "state_s", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ trunc_ln367_1 sc_in sc_lv 2 signal 1 } 
...
set Spec2ImplPortList { 
	state_s { ap_memory {  { state_s_address0 mem_address 1 5 }  { state_s_ce0 mem_ce 1 1 }  { state_s_q0 in_data 0 64 } } }
	trunc_ln367_1 { ap_none {  { trunc_ln367_1 in_data 0 2 } } }
	buf_r { ap_memory {  { buf_r_address0 mem_address 1 10 }  { buf_r_ce0 mem_ce 1 1 }  { buf_r_we0 mem_we 1 1 }  { buf_r_d0 mem_din 1 8 }  { buf_r_address1 MemPortADDR2 1 10 }  { buf_r_ce1 MemPortCE2 1 1 }  { buf_r_we1 MemPortWE2 1 1 }  { buf_r_d1 MemPortDIN2 1 8 } } }
}
