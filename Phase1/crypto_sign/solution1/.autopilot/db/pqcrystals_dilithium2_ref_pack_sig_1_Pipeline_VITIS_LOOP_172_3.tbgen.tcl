set moduleName pqcrystals_dilithium2_ref_pack_sig_1_Pipeline_VITIS_LOOP_172_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_pack_sig.1_Pipeline_VITIS_LOOP_172_3}
