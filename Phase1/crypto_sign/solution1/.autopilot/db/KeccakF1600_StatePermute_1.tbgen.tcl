...
set C_modelArgList {
	...
	{ KeccakF_RoundConstants int 64 regular {array 24 { 1 1 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "state_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "KeccakF_RoundConstants", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ KeccakF_RoundConstants_address0 sc_out sc_lv 5 signal 1 } 
	{ KeccakF_RoundConstants_ce0 sc_out sc_logic 1 signal 1 } 
	{ KeccakF_RoundConstants_q0 sc_in sc_lv 64 signal 1 } 
	{ KeccakF_RoundConstants_address1 sc_out sc_lv 5 signal 1 } 
	{ KeccakF_RoundConstants_ce1 sc_out sc_logic 1 signal 1 } 
	{ KeccakF_RoundConstants_q1 sc_in sc_lv 64 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "KeccakF_RoundConstants_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "KeccakF_RoundConstants", "role": "address0" }} , 
 	{ "name": "KeccakF_RoundConstants_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "KeccakF_RoundConstants", "role": "ce0" }} , 
 	{ "name": "KeccakF_RoundConstants_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "KeccakF_RoundConstants", "role": "q0" }} , 
 	{ "name": "KeccakF_RoundConstants_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "KeccakF_RoundConstants", "role": "address1" }} , 
 	{ "name": "KeccakF_RoundConstants_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "KeccakF_RoundConstants", "role": "ce1" }} , 
 	{ "name": "KeccakF_RoundConstants_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "KeccakF_RoundConstants", "role": "q1" }}  ]}
...
set Spec2ImplPortList { 
	state_0 { ap_memory {  { state_0_address0 mem_address 1 5 }  { state_0_ce0 mem_ce 1 1 }  { state_0_we0 mem_we 1 1 }  { state_0_d0 mem_din 1 64 }  { state_0_q0 in_data 0 64 }  { state_0_address1 MemPortADDR2 1 5 }  { state_0_ce1 MemPortCE2 1 1 }  { state_0_we1 MemPortWE2 1 1 }  { state_0_d1 MemPortDIN2 1 64 }  { state_0_q1 in_data 0 64 } } }
	KeccakF_RoundConstants { ap_memory {  { KeccakF_RoundConstants_address0 mem_address 1 5 }  { KeccakF_RoundConstants_ce0 mem_ce 1 1 }  { KeccakF_RoundConstants_q0 in_data 0 64 }  { KeccakF_RoundConstants_address1 MemPortADDR2 1 5 }  { KeccakF_RoundConstants_ce1 MemPortCE2 1 1 }  { KeccakF_RoundConstants_q1 in_data 0 64 } } }
}
