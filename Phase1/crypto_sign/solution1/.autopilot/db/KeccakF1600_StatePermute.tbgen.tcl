...
set Spec2ImplPortList { 
	state { ap_memory {  { state_address0 mem_address 1 5 }  { state_ce0 mem_ce 1 1 }  { state_we0 mem_we 1 1 }  { state_d0 mem_din 1 64 }  { state_q0 in_data 0 64 }  { state_address1 MemPortADDR2 1 5 }  { state_ce1 MemPortCE2 1 1 }  { state_we1 MemPortWE2 1 1 }  { state_d1 MemPortDIN2 1 64 }  { state_q1 in_data 0 64 } } }
}
