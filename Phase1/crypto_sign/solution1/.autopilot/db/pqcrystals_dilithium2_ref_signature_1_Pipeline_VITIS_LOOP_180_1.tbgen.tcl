set moduleName pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_180_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_signature.1_Pipeline_VITIS_LOOP_180_1}
...
set C_modelArgList {
	...
	{ w1_vec_coeffs int 32 regular {array 1024 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "i_17", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "w1_vec_coeffs", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ i_17 sc_in sc_lv 2 signal 0 } 
	{ mat_address0 sc_out sc_lv 12 signal 1 } 
	{ mat_ce0 sc_out sc_logic 1 signal 1 } 
	{ mat_q0 sc_in sc_lv 23 signal 1 } 
	{ z_vec_coeffs_address0 sc_out sc_lv 10 signal 2 } 
	{ z_vec_coeffs_ce0 sc_out sc_logic 1 signal 2 } 
	{ z_vec_coeffs_q0 sc_in sc_lv 32 signal 2 } 
	{ zext_ln181_3 sc_in sc_lv 10 signal 3 } 
	{ w1_vec_coeffs_address0 sc_out sc_lv 10 signal 4 } 
	{ w1_vec_coeffs_ce0 sc_out sc_logic 1 signal 4 } 
	{ w1_vec_coeffs_we0 sc_out sc_logic 1 signal 4 } 
	{ w1_vec_coeffs_d0 sc_out sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "i_17", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "i_17", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_23ns_55_1_1_U193", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_27ns_32_1_1_U194", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_24s_55_1_1_U195", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	w1_vec_coeffs { ap_memory {  { w1_vec_coeffs_address0 mem_address 1 10 }  { w1_vec_coeffs_ce0 mem_ce 1 1 }  { w1_vec_coeffs_we0 mem_we 1 1 }  { w1_vec_coeffs_d0 mem_din 1 32 } } }
}
