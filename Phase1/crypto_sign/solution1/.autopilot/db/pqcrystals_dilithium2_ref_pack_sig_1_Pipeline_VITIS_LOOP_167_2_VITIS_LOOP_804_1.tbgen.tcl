set moduleName pqcrystals_dilithium2_ref_pack_sig_1_Pipeline_VITIS_LOOP_167_2_VITIS_LOOP_804_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_pack_sig.1_Pipeline_VITIS_LOOP_167_2_VITIS_LOOP_804_1}
...
set portList { 
	...
	{ z_address1 sc_out sc_lv 10 signal 0 } 
	{ z_ce1 sc_out sc_logic 1 signal 0 } 
	{ z_q1 sc_in sc_lv 32 signal 0 } 
...
set Spec2ImplPortList { 
	z { ap_memory {  { z_address0 mem_address 1 10 }  { z_ce0 mem_ce 1 1 }  { z_q0 in_data 0 32 }  { z_address1 MemPortADDR2 1 10 }  { z_ce1 MemPortCE2 1 1 }  { z_q1 in_data 0 32 } } }
