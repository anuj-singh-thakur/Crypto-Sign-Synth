set moduleName pqcrystals_dilithium2_ref_signature_1_Pipeline_VITIS_LOOP_142_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {pqcrystals_dilithium2_ref_signature.1_Pipeline_VITIS_LOOP_142_6}
...
set portList { 
	...
	{ t0_vec_coeffs_we0 sc_out sc_logic 1 signal 0 } 
	{ t0_vec_coeffs_d0 sc_out sc_lv 32 signal 0 } 
	{ t0_vec_coeffs_address1 sc_out sc_lv 10 signal 0 } 
	{ t0_vec_coeffs_ce1 sc_out sc_logic 1 signal 0 } 
	{ t0_vec_coeffs_we1 sc_out sc_logic 1 signal 0 } 
	{ t0_vec_coeffs_d1 sc_out sc_lv 32 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "t0_vec_coeffs", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_pqcrystals_dilithium2_ref_polyt0_unpack_1_fu_50", "Port" : "r", "Inst_start_state" : "2", "Inst_end_state" : "210"}]},
			{"Name" : "sk", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_pqcrystals_dilithium2_ref_polyt0_unpack_1_fu_50", "Port" : "sk", "Inst_start_state" : "2", "Inst_end_state" : "210"}]}],
		"Loop" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_pqcrystals_dilithium2_ref_polyt0_unpack_1_fu_50", "Parent" : "0",
