# 1 "/home/shikha/Final_Assignment/dilithium2/test/test_dilithium.c"
# 1 "/home/shikha/Final_Assignment/dilithium2/test/test_dilithium.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/shikha/Final_Assignment/dilithium2/test/test_dilithium.c" 2
...
typedef int wchar_t;
# 2 "/home/shikha/Final_Assignment/dilithium2/test/test_dilithium.c" 2
...
# 3 "/home/shikha/Final_Assignment/dilithium2/test/test_dilithium.c" 2
...
# 4 "/home/shikha/Final_Assignment/dilithium2/test/test_dilithium.c" 2
# 1 "/home/shikha/Final_Assignment/dilithium2/test/../randombytes.h" 1



# 1 "/home/shikha/Vivado/Vitis_HLS/2022.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 1 3
# 5 "/home/shikha/Final_Assignment/dilithium2/test/../randombytes.h" 2


void randombytes(uint8_t *out, size_t outlen);
# 5 "/home/shikha/Final_Assignment/dilithium2/test/test_dilithium.c" 2
# 1 "/home/shikha/Final_Assignment/dilithium2/test/../sign.h" 1



# 1 "/home/shikha/Vivado/Vitis_HLS/2022.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 1 3
# 5 "/home/shikha/Final_Assignment/dilithium2/test/../sign.h" 2

# 1 "/home/shikha/Final_Assignment/dilithium2/test/../params.h" 1



# 1 "/home/shikha/Final_Assignment/dilithium2/test/../config.h" 1
# 5 "/home/shikha/Final_Assignment/dilithium2/test/../params.h" 2
# 7 "/home/shikha/Final_Assignment/dilithium2/test/../sign.h" 2
# 1 "/home/shikha/Final_Assignment/dilithium2/test/../polyvec.h" 1





# 1 "/home/shikha/Final_Assignment/dilithium2/test/../poly.h" 1
...
# 7 "/home/shikha/Final_Assignment/dilithium2/test/../polyvec.h" 2
...
# 8 "/home/shikha/Final_Assignment/dilithium2/test/../sign.h" 2
...
int pqcrystals_dilithium2_ref_open(uint8_t *m, size_t *mlen,
                     ...
                     const uint8_t *pk);
# 6 "/home/shikha/Final_Assignment/dilithium2/test/test_dilithium.c" 2
...
int main(void)
{
  ...
  size_t mlen, smlen;
  uint8_t m[3300] = {0};
  uint8_t sm[3300 + (32 + 4*576 + (80 + 4))];
  uint8_t m2[3300 + (32 + 4*576 + (80 + 4))];
  uint8_t pk[(32 + 4*320)];
  uint8_t sk[(2*32 + 48 + 4*96 + 4*96 + 4*416)];

  for(i = 0; i < 1; ++i) {
    randombytes(m, 3300);

    pqcrystals_dilithium2_ref_keypair(pk, sk);
    pqcrystals_dilithium2_ref(sm, &smlen, m, 3300, sk);
    ret = pqcrystals_dilithium2_ref_open(m2, &mlen, sm, smlen, pk);
